...
(function (t) {
        ...
        window.tram = (function (t) {
            ...
            var l = (function (t, e, n) {
                ...
                S = function (t) {
                    ...
                    for (e = 0; e < T.length; e++) if ((n = T[e] + i) in L.style) return {dom: n, css: C[e] + t};
                },
                R = (e.support = {
            ...
            if (R.transition) {
                var z = R.timing.dom;
                if (((L.style[z] = f["ease-in-back"][0]), !L.style[z])) for (var M in d) f[M][0] = d[M];
            }
                ...
                P = l(function (e) {
                    ...
                    function h(t, e, i) {
                        var o,
                            ...
                            c = e !== p,
                            l = {};
                        for (o in t) (s = t[o]), o in Z ? (l.transform || (l.transform = {}), (l.transform[o] = s)) : (w.test(o) && (o = n(o)), o in Y ? (l[o] = s) : (u || (u = {}), (u[o] = s)));
                        for (o in l) {
                ...
                W = l(function (e) {
                    function n() {
                        var t,
                            ...
                            i,
                            r = u.length;
                        if (r) for (I(n), e = D(), t = r; t--;) (i = u[t]) && i.render(e);
                    }
    ...
    function (t, e, n) {
        n(4), n(7), n(8), n(9), n(10), n(11), n(12), (t.exports = n(17));
    },
    function (t, e, n) {
        "use strict";
        var i = n(0);
                                ...
                                window.setTimeout(
                                    function () {
                                        !(function (e, n) {
                                            ...
                                            m(d, "add"), d.get(0).focus({preventScroll: !0}), m(d, "remove");
                                        });
                                    },
                                    e ? 0 : 300
                                ));
        ...
        r.define(
            ...
            (t.exports = function (t, e) {
                ...
                function y(e, n) {
                    ...
                    (r.done = a.find("> .w-form-done")),
                        ...
                        r.fileUploads.each(function (e) {
                            !(function (e, n) {
                                ...
                                function A(t) {
                                    if (t) return E(t);
                                    a.toggle(!1), s.css("display", "inline-block"), (n.fileUploads[e].uploading = !1), L() || x(n);
                                }
                    ...
                    (r.handler = null), (r.redirect = i.attr("data-redirect")), g.test(s) ? (r.handler = A) : s || (o ? (r.handler = O) : b());
                }
        ...
        i.define(
            ...
            (t.exports = function (t, e) {
                ...
                function A(n, i) {
                    ...
                    a || (a = t.data(i, m, {open: !1, el: r, config: {}, selectedIdx: -1})),
                        ...
                        (a.outside = (function (e) {
                            ...
                            return function (n) {
                                var i = t(n.target);
                                (u && i.closest(".w-editor-bem-EditorOverlay").length) || I(e, i);
                            };
                        })(a));
                                    ...
                                    (function (t) {
                                        return function (e) {
                                            switch (e.keyCode) {
                                                case o.SPACE:
                                                case o.ENTER:
                                                    return z(t)(), e.preventDefault(), e.stopPropagation();
                                                case o.ESCAPE:
                ...
                (c.ready = c.design = c.preview = function () {
                    ...
                    (c.destroy = function () {
                        (_ = t()), E(), a && a.length && a.each(L);
                    });
                var I = h(function (t, e) {
                    if (t.open) {
                ...
                function F(t, e) {
                    if (!t.open) {
                        (t.open = !0), t.menu.each(j), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
                        var n = t.config;
                        ...
                        var r = $(t),
                            ...
                            u = t.el.height(),
                            c = t.el[0];
                        if ((D(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e)) p();
                        else {
